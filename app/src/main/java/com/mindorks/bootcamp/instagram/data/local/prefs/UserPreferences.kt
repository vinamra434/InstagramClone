...
class UserPreferences @Inject constructor(private val prefs: SharedPreferences) {
    ...
    companion object {
        ...
        const val KEY_USER_PICTURE_URL = "PREF_KEY_PICTURE_URL"
    ...
    fun getProfileUrl(): String? =
        prefs.getString(KEY_USER_PICTURE_URL, null)

    fun setProfileUrl(url: String) =
        prefs.edit().putString(KEY_USER_PICTURE_URL, url).apply()

    fun removeProfilePic() =
        prefs.edit().remove(KEY_USER_PICTURE_URL).apply()
